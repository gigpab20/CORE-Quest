...
public class RockGolemRender extends GeoEntityRenderer<RockGolemEntity> {
    public RockGolemRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new RockGolemModel());
        this.shadowRadius = 0.3f;
    }

    @Override
    public ResourceLocation getTextureLocation(RockGolemEntity animatable) {
        return new ResourceLocation(Demo_2023.MODID, "textures/entity/rockgolem_texture.png");
    }

    @Override
    public RenderType getRenderType(RockGolemEntity animatable, float partialTick, PoseStack poseStack,
